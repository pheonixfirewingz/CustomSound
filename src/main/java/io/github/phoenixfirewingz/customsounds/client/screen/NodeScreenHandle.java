...
public class NodeScreenHandle extends ScreenHandler {
    ...
    public class NodeScreen extends HandledScreen<NodeScreenHandle> {
        ...
        {
            ((SoundNode.SoundNodeEntity)handler.entity).setUrl(s);
        }

        @Override
        public void removed() {
            ((SoundNode.SoundNodeEntity)handler.entity).setUrl(text.getText());
        ...
        protected void init() {
            ...
            this.text.setText(((SoundNode.SoundNodeEntity)handler.entity).getUrl());
